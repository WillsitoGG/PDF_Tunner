...
- **2026-09-03:** Snapshot generation Run 33748234868 produced deterministic primary workflow/diagnostics blobs after all integration guards passed; Actions cannot push workflow-path changes, so the GitHub connector will promote these exact blobs.
